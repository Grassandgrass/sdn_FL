...
import benchmark.unswnb15_muti_classification.model.seresnet18 as models

from utils.fmodule import FModule


class Model(FModule):
    def __init__(self, fc_hidden1=512, fc_hidden2=512, drop_p=0.3, num_classes=10):
    ...
    def forward(self, x_3d):
        ...
        x_3d = x_3d.view((x_3d.shape[0], 32, 32))  # torch.Size([512, 32, 32])
        x_3d = x_3d.unsqueeze(1)

        x_1 = self.conv1_1(x_3d) # torch.Size([512, 1, 32, 32])
        # x_1 = self.conv1_1(self.W * x_3d + x_3d)
        x_2 = self.conv1_2(x_3d) # torch.Size([512, 32, 32, 32])
        # print("torch.cat((x_1, x_2)", torch.cat((x_1, x_2)).size())

        x = self.resnet(torch.cat((x_1, x_2), dim=1)) # torch.Size([1024, 32, 32, 32])
    ...
    def save(self):
        ...
        torch.save(model.state_dict(), "D:/Project_Test/easyFL-copy/benchmark/model/model_parameter-3lmnet.pkl")
        # new_model = Model()  # 调用模型Model
        # new_model.load_state_dict(torch.load("./model/model_parameter.pkl"))  # 加载模型参数
