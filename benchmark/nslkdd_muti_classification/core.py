...
class TaskGen(DefaultTaskGen):
    ...
    def __init__(self, dist_id, num_clients = 1, skewness = 0.5, selected_labels = [0, 1, 2, 3, 4], #  ['10000' '01000' '00100' '00010' '00001']
        ...
        super(TaskGen, self).__init__(benchmark='nslkdd_muti_classification',
                                      dist_id=dist_id,
    ...
    def load_data(self):
        ...
        # testx = np.load('D:/Project_Test/easyFL/benchmark/nslkdd_muti_classification/data/test_data.npy', allow_pickle=True)
        # testy = np.load('D:/Project_Test/easyFL/benchmark/nslkdd_muti_classification/data/test_label.npy', allow_pickle=True)
