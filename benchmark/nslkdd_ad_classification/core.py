...
# from benchmark.nslkdd_ad_classification.nsl_kdd_processing import load_data
...
class TaskGen(DefaultTaskGen):
    ...
    def __init__(self, dist_id, num_clients = 1, skewness = 0.5, selected_labels = [0, 1, 2, 3, 4], #  ['10000' '01000' '00100' '00010' '00001']
                 seed=0, rawdata_path='./benchmark/RAW_DATA/NSL-KDD'):
        super(TaskGen, self).__init__(benchmark='nslkdd_ad_classification',
                                      dist_id=dist_id,
    ...
    def load_data(self):
        ...
        trainx = np.load('D:/Project_Test/easyFL/benchmark/nslkdd_ad_classification/data/train_data.npy', allow_pickle=True)
        trainy = np.load('D:/Project_Test/easyFL/benchmark/nslkdd_ad_classification/data/train_label.npy ', allow_pickle=True)
        testx = np.load('D:/Project_Test/easyFL/benchmark/nslkdd_ad_classification/data/test_data.npy', allow_pickle=True)
        testy = np.load('D:/Project_Test/easyFL/benchmark/nslkdd_ad_classification/data/test_label.npy', allow_pickle=True)
